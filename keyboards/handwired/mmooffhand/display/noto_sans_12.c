 ...
 * Size: 12 px
 * Bpp: 4
 * Opts: --bpp 4 --size 12 --no-compress --font NotoSans-VariableFont_wdth,wght.ttf --symbols abcdefghijklmnopqrstuvwxyz ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!@#$%^&*()`~-_=+[{]}\|;:'",<.>/? --format lvgl -o noto_sans_12.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap12[] = {
    /* U+0020 " " */
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc12[] = {
...
static const lv_font_fmt_txt_cmap_t cmaps12[] =
{
    {
...
#if LVGL_VERSION_MAJOR >= 8
static const lv_font_fmt_txt_dsc_t font_dsc12 = {
#else
static lv_font_fmt_txt_dsc_t font_dsc12 = {
#endif
    .glyph_bitmap = glyph_bitmap12,
    .glyph_dsc = glyph_dsc12,
    .cmaps = cmaps12,
    .kern_dsc = NULL,
    .kern_scale = 0,
    .cmap_num = 1,
...
#endif
    .dsc = &font_dsc12,          /*The custom font data. Will be accessed by `get_glyph_bitmap12/dsc` */
